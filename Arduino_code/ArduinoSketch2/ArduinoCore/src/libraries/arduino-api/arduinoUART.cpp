 ...
 * 
 */
void arduinoUART::setUART(uint8_t uart)
{
    _uart = uart;
}
 ...
 * 
 * name: setBaudrate
 * @param baurate to use
 * @return void
 * 
 */
void arduinoUART::setBaudrate(uint32_t baudrate)
{
    _baudrate = baudrate;
}
 ...
 *  @arg    '1' if error
 */
uint8_t arduinoUART::parseString(char* str, uint16_t size, char* delimiters, uint8_t n)
{
    // define the pointer to seek for token
    char* pch;
 ...
 *  @arg    '1' if error
 */
uint8_t arduinoUART::parseUint8(uint8_t* value, char* delimiters, uint8_t n)
{
    // define the pointer to seek for token
    char* pch;
    uint32_t aux;
 ...
 *  @arg    '1' if error
 */
uint8_t arduinoUART::parseInt32(int32_t* value, char* delimiters, uint8_t n)
{
    // define the pointer to seek for token
    char* pch;
    uint32_t aux;
