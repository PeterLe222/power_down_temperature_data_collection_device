 ...
 * @return  void
 */
void arduinoSigfox::generator(uint8_t type, int n, const char *cmdCode, ...)
{   
    // define pointer 
    char* pointer;
 ...
 * @return  parsed value
 */
uint32_t arduinoSigfox::parseHexValue()
{
    char * pch; 
 ...
 * @return  parsed value
 */
uint8_t arduinoSigfox::parseUint8Value()
{
    char * pch; 
    pch = strtok((char*) _buffer,"\r\nOKERROR");
    if (pch != NULL)
 ...
 * @return  parsed value
 */
uint32_t arduinoSigfox::parseUint32Value()
{
    char * pch; 
    pch = strtok((char*) _buffer,"\r\nOKERROR");
    if (pch != NULL)
 ...
 */
uint8_t arduinoSigfox::ON(uint8_t socket)
{
    _baudrate = UART_RATE;
    _uart = socket;
    ...
    if (socket == SOCKET0)
    {  
        _uart = SOCKET0;        //Only one UART in Arduino UNO

        Utils.setONSocket0();   //Set ON Before MUX
        Utils.setMUXSocket0();
    }
    ...
    {  
        ...
        Utils.setONSocket1();   //Set ON Before MUX
        Utils.setMUXSocket1();
    }
    // Open UART
    beginUART();    
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduinoSigfox::OFF(uint8_t socket)
{
    if (socket == SOCKET0)
    {  
        _uart = SOCKET0;        //Only one UART in Arduino UNO
 ...
 * 
 */ 
uint8_t arduinoSigfox::check()
{   
    uint8_t status; 
    
    // send command
    status = sendCommand((char *)"AT\r", AT_OK, AT_ERROR, 5000 );
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduinoSigfox::getID()
{
    uint8_t answer;
    
    // 1. send command
    answer = sendCommand((char *)"ATI7\r", (char *)"\r\n", AT_ERROR, 1000);
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduinoSigfox::setPower(uint8_t power)
{
    uint8_t answer;
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduinoSigfox::getPower()
{
    uint8_t answer;
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduinoSigfox::saveSettings()
{   
    // enter command mode
    if( sendCommand((char *)"AT&W\r", AT_OK, AT_ERROR, 1000) != 1)
    {
        return SIGFOX_ANSWER_ERROR;
    }
 ...
 * 
 */
uint8_t arduinoSigfox::factorySettings()
{
    uint8_t status; 
    
    status = sendCommand((char *)"AT&F\r", AT_OK, AT_ERROR, 1000);
    if( status == 1 )
    {
        //save config
        status = saveSettings();
 ...
 * 
 */
uint8_t arduinoSigfox::defaultConfiguration()
{
    uint8_t answer; 
    
    answer = sendCommand((char *)"ATZ\r", AT_OK, AT_ERROR, 1000);
    if( answer == 1 )
    {
        delay(2000);
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduinoSigfox::send(char* data)
{
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduinoSigfox::send(uint8_t* data, uint16_t length)
{
    //define buffer
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduinoSigfox::sendACK(char* data)
{
    uint16_t length = strlen(data);
    uint8_t status;
    ...
    status = waitFor((char *)"+RX BEGIN", AT_ERROR, 20000);
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduinoSigfox::sendACK(uint8_t* data, uint16_t length)
{
    //define buffer
    char ascii_command[30];
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduinoSigfox::testTransmit(uint16_t count, uint16_t period, int channel)
{
    char param1[20];
    char param2[20];
    char param3[20];
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduinoSigfox::showFirmware()
{
    uint8_t status;
    
    // enter command mode
    if( sendCommand((char *)"ATI13\r", (char *)"SOFT", AT_ERROR, 1000) != 1)
    {
        return SIGFOX_ANSWER_ERROR;
    }
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduinoSigfox::sendKeepAlive()
{
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduinoSigfox::sendKeepAlive(uint8_t period)
{
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduinoSigfox::continuosWave(uint32_t freq, bool enable)
{
    char param1[20];
 ...
 * 
 */
uint8_t arduinoSigfox::setAddressLAN(uint32_t naddress)
{
    uint8_t status; 
 ...
 * 
 */
uint8_t arduinoSigfox::getAddressLAN()
{
    uint8_t status; 
    
    status = sendCommand((char *)"ATS400?\r", (char *)"\r\n", AT_ERROR, 1000);
 ...
 * 
 */
uint8_t arduinoSigfox::setMask(uint32_t nmask)
{
    uint8_t status; 
 ...
 * 
 */
uint8_t arduinoSigfox::getMask()
{
    uint8_t status; 
    
    status = sendCommand((char *)"ATS401?\r", (char *)"\r\n", AT_ERROR, 1000);
 ...
 * 
 */
uint8_t arduinoSigfox::setFrequency(uint32_t freq)
{
    uint8_t status; 
 ...
 * 
 */
uint8_t arduinoSigfox::getFrequency()
{
    uint8_t status; 
    
    status = sendCommand((char *)"ATS403?\r", (char *)"\r\n", AT_ERROR, 1000);
 ...
 * 
 */
uint8_t arduinoSigfox::setPowerLAN(int power)
{
    uint8_t status; 
 ...
 * 
 */
uint8_t arduinoSigfox::getPowerLAN()
{
    uint8_t status; 
    
    status = sendCommand((char *)"ATS404?\r", (char *)"\r\n", AT_ERROR, 1000);
 ...
 * 
 */
uint8_t arduinoSigfox::sendLAN(uint8_t* data, uint16_t length)
{   
 ...
 * 
 */
uint8_t arduinoSigfox::sendLAN(char* data)
{   
    uint8_t status; 
    uint16_t length = strlen(data);
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduinoSigfox::parsePacketLAN()
{
    char* pch;  
 ...
 * 
 */
uint8_t arduinoSigfox::receive(uint32_t wait)
{   
    uint8_t status; 
 ...
 * 
 */
uint8_t arduinoSigfox::setMultiPacket()
{
    uint8_t status; 
    status = sendCommand((char *)"AT$RL=2\r", AT_OK, AT_ERROR, 1000);
 ...
 * 
 */
uint8_t arduinoSigfox::disableRX()
{
    uint8_t status; 
    status = sendCommand((char *)"AT$RL=0\r", AT_OK, AT_ERROR, 1000);
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduinoSigfox::getMultiPacket(uint32_t time)
{
    uint8_t status;
    
    status = waitFor((char *)"+RX_LAN=",time*1000);
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduinoSigfox::getRegion()
{
    uint8_t status;
    
    status = sendCommand((char *)"ATS304?\r", (char *)"\r\n", AT_ERROR, 1000);
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduinoSigfox::setMacroChannelBitmask(char* bitmask)
{
    uint8_t answer;
    
    snprintf(_command, sizeof(_command), (char *)"ATS306=%s\r", bitmask);
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduinoSigfox::getMacroChannelBitmask()
{
    uint8_t answer;
    
    snprintf(_command, sizeof(_command), (char *)"ATS306?\r");
    ...
    // get value from received data
    answer = parseString(_macroChannelBitmask, sizeof(_macroChannelBitmask), (char *)"\r\n", 1);
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduinoSigfox::setMacroChannel(uint8_t config)
{
    uint8_t answer;
    
    snprintf(_command, sizeof(_command), (char *)"ATS307=%u\r", config);
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduinoSigfox::getMacroChannel()
{
    uint8_t answer;
    
    snprintf(_command, sizeof(_command), (char *)"ATS307?\r");
    ...
    // get value from received data
    answer = parseUint8(&_macroChannel, (char *)"\r\n", 1);
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduinoSigfox::setDownFreqOffset(int32_t offset)
{
    uint8_t answer;
    
    snprintf(_command, sizeof(_command), (char *)"ATS308=%li\r", offset);
 ...
 *  @arg    'SIGFOX_NO_ANSWER' if no answer 
 */
uint8_t arduinoSigfox::getDownFreqOffset()
{
    uint8_t answer;
    
    snprintf(_command, sizeof(_command), (char *)"ATS308?\r");
    ...
    // get value from received data
    answer = parseInt32(&_downFreqOffset, (char *)"\r\n");
...
arduinoSigfox Sigfox = arduinoSigfox();
